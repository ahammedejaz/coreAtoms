                                            ...
                                            <div className="mt-3 space-y-2">
                                                ...
                                                <div className="grid grid-cols-2 gap-2">
                                                    ...
                                                    {(() => {
                                                        ...
                                                        return waUrl ? (
                                                            sent ? (
                                                                <div className="w-full flex items-center justify-center gap-1.5 rounded-xl bg-stone-100 px-2 py-2 text-xs font-semibold text-stone-400">
                                                                ...
                                                                <a
                                                                    ...
                                                                    className="w-full flex items-center justify-center gap-1.5 rounded-xl bg-[#25D366] px-2 py-2 text-xs font-semibold text-white shadow-sm hover:bg-[#1ebe5b] active:scale-95 transition-all duration-150"
                                                                >
                                                            ...
                                                            <div className="w-full flex items-center justify-center rounded-xl bg-stone-50 px-2 py-2 text-[10px] text-stone-300">No phone</div>
                                                        );
                                                    })()}
                                                </div>
                                            </div>
