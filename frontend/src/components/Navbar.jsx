    ...
    <>
      ...
      {toast && (
        <div className="pointer-events-none fixed right-4 top-20 z-[60]">
          <div className="rounded-xl border border-neutral-200 bg-white px-4 py-2 text-sm text-neutral-900 shadow-lg animate-in slide-in-from-right-5 duration-200">
            {toast}
          </div>
        </div>
      )}
