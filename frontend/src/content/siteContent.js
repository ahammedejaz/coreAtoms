...
export const PAGES = [
  ...
  },
  {
    key: "page_account",
    title: "Account pages",
    description: "The photographic panel beside the sign-in, forgot-password and reset forms, and the words on the sign-in form.",
    fields: [
      f("panelImage", "Panel photograph", "image", { hint: "Leave empty to use the first home hero photograph." }),
      f("panelEyebrow", "Panel eyebrow (small label beside the logo)", "text"),
      ...
      f("forgotTitle", "Forgot password heading", "text"),
      f("forgotSubtitle", "Forgot password line", "text"),
      f("forgotSentTitle", "Reset link sent heading", "text"),
      f("forgotSentSubtitle", "Reset link sent line", "text"),
      f("resetTitle", "New password heading", "text"),
      f("resetSubtitle", "New password line", "text"),
      f("loginTab", "Sign in tab label", "text"),
      f("signupTab", "Create account tab label", "text"),
      f("formNote", "Note under the form", "text"),
    ],
    defaults: {
      panelImage: "",
      panelEyebrow: "Member account",
      ...
      forgotSentSubtitle: "We've sent a reset link to your inbox.",
      resetTitle: "Set a new password",
      resetSubtitle: "Choose a strong password for your account.",
      loginTab: "Sign in",
      signupTab: "Create account",
      formNote: "Your details stay with Core Atoms and are never sold or shared.",
    },
  },
  {
    key: "page_orders",
